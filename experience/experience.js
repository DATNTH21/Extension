...
exports.checkUncoverage = exports.checkUncovered = exports.getCoverageReport = exports.getTestStruct = exports.getCodeStruct = void 0;
var fa = require("fs");
...
function getCodeStruct(source, apiKey) {
    return __awaiter(this, void 0, void 0, function () {
        var getCodeCoveragePromptFile, fileCode, prompt, input, result, filePathOut, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiKey = 'AIzaSyDXmoUw6_s7FgJiSKKAPcDvJgaLJ1xMVrw'; // Assuming you're getting your API key from an environment variable
                    getCodeCoveragePromptFile = path.join(__dirname, 'prompts/getCodeStruct.txt');
                ...
                case 2:
                    result = _a.sent();
                    filePathOut = path.join(__dirname, 'Output/StructCode.txt');
...
function getTestStruct(source, test, apiKey) {
    return __awaiter(this, void 0, void 0, function () {
        var fileCode, fileTest, getTestCoveragePromptFile, prompt, input, result, filePathOut, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiKey = 'AIzaSyDXmoUw6_s7FgJiSKKAPcDvJgaLJ1xMVrw'; // Assuming you're getting your API key from an environment variable
                    fileCode = path.join(__dirname, 'Input/source.txt');
                    fileTest = path.join(__dirname, 'Input/test90.txt');
                    source = fa.readFileSync(fileCode, 'utf8');
                    test = fa.readFileSync(fileTest, 'utf8');
                    getTestCoveragePromptFile = path.join(__dirname, 'prompts/getTestStruct.txt');
                ...
                case 2:
                    result = _a.sent();
                    filePathOut = path.join(__dirname, 'Output/StructTest.txt');
                    return [4 /*yield*/, fs_1.promises.writeFile(filePathOut, result, { encoding: 'utf8' })];
                case 3:
                    _a.sent();
                    return [2 /*return*/, result];
...
function getCoverageReport(source, test, apiKey) {
    return __awaiter(this, void 0, void 0, function () {
        var getCoveragePromptFile, prompt, CodeStruct, TestStruct, input, result, filePathOut, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiKey = 'AIzaSyDXmoUw6_s7FgJiSKKAPcDvJgaLJ1xMVrw'; // Assuming you're getting your API key from an environment variable
                    getCoveragePromptFile = path.join(__dirname, 'prompts/getCoverage.txt');
                    prompt = fa.readFileSync(getCoveragePromptFile, 'utf8');
                    return [4 /*yield*/, getCodeStruct(source, apiKey)];
                case 1:
                    CodeStruct = _a.sent();
                ...
                case 4:
                    result = _a.sent();
                    filePathOut = path.join(__dirname, 'Output/TestCoverage.txt');
                    return [4 /*yield*/, fs_1.promises.writeFile(filePathOut, result, { encoding: 'utf8' })];
                case 5:
                    _a.sent();
                    return [2 /*return*/, result];
...
function checkUncovered(source, test, apiKey) {
    return __awaiter(this, void 0, void 0, function () {
        var getPromptFile, prompt, fileCode, fileTest, report, input, result, filePathOut, err_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiKey = 'AIzaSyDXmoUw6_s7FgJiSKKAPcDvJgaLJ1xMVrw'; // Assuming you're getting your API key from an environment variable
                    getPromptFile = path.join(__dirname, 'prompts/checkUncovered.txt');
                ...
                case 3:
                    result = _a.sent();
                    filePathOut = path.join(__dirname, 'Output/CheckedTestCoverage.txt');
                    return [4 /*yield*/, fs_1.promises.writeFile(filePathOut, result, { encoding: 'utf8' })];
                case 4:
                    _a.sent();
                    return [2 /*return*/, result];
...
function checkUncoverage(source, test, apiKey) {
    return __awaiter(this, void 0, void 0, function () {
        var getPromptFile, prompt, fileCode, fileTest, report, input, result, filePathOut, err_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiKey = 'AIzaSyDXmoUw6_s7FgJiSKKAPcDvJgaLJ1xMVrw'; // Assuming you're getting your API key from an environment variable
                    getPromptFile = path.join(__dirname, 'prompts/checkCoverage.txt');
                    prompt = fa.readFileSync(getPromptFile, 'utf8');
                    fileCode = path.join(__dirname, 'Input/source.txt');
                    fileTest = path.join(__dirname, 'Input/test90.txt');
                    source = fa.readFileSync(fileCode, 'utf8');
                ...
                case 3:
                    result = _a.sent();
                    filePathOut = path.join(__dirname, 'Output/CheckedCoverage.txt');
                    return [4 /*yield*/, fs_1.promises.writeFile(filePathOut, result, { encoding: 'utf8' })];
                case 4:
                    _a.sent();
                    return [2 /*return*/, result];
...
exports.checkUncoverage = checkUncoverage;
