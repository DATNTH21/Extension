...
exports.getCodeStruct = exports.getTestScope = void 0;
var fa = require("fs");
...
function getCodeStruct(source, test, apiKey) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    getTestCoveragePromptFile = path.join(__dirname, 'prompts/preprocessing/getTestStruct.txt');
                ...
                case 2:
                    result = _a.sent();
                    filePathOut = path.join(__dirname, 'Output/preprocessing/StructTest.txt');
                    return [4 /*yield*/, fs_1.promises.writeFile(filePathOut, result, { encoding: 'utf8' })];
                case 3:
                    _a.sent();
                    return [2 /*return*/, result];
