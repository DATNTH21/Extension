    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    testscope = _a.sent();
                    return [4 /*yield*/, (0, experiencePre_1.getConstructors)(source, apiKey)];
                case 2:
                    constructors = _a.sent();
                    return [4 /*yield*/, (0, experiencePre_1.getAuxiliaryMethods)(source, apiKey)];
                case 3:
                    auxiliarymethods = _a.sent();
                    return [4 /*yield*/, (0, experiencePre_1.getChainToPrivateMethods)(source, apiKey)];
                case 4:
                    chainedmethods = _a.sent();
                    return [4 /*yield*/, (0, experiencePre_1.getMockingSetup)(source, apiKey)];
                case 5:
                    mockingsetup = _a.sent();
                    return [4 /*yield*/, (0, experiencePre_1.getCodeStruct)(source, apiKey)];
                case 6:
                    sourcestructure = _a.sent();
